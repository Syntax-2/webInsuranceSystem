...
if($_SERVER["REQUEST_METHOD"] == "GET"){
		$darbuotojo_username=$_GET["darbuotojo_username"];
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "UPDATE darbuotojai SET darbuotojo_username='$darbuotojo_username', darbuotojo_slaptazodis = '$darbuotojo_slaptazodis', darbuotojo_email = '$darbuotojo_email', telefono_nr = '$telefono_nr' WHERE darbuotojo_username='$darbuotojo_username'";
